...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "code_execution": "20/min",
        "code_submission": "10/min",
        "ai_generation": "5/min",
    },
...
# Backwards-compatible helpers retained for the Phase 1 CORS regression tests.
_is_valid_cors_origin = _valid_origin
